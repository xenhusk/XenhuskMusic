...
class CustomCreatePlaylistDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        _binding = DialogCreatePlaylistCustomBinding.inflate(layoutInflater)
    ...
    companion object {
        ...
        fun create(songs: List<Song>? = null): CustomCreatePlaylistDialog {
            if (songs.isNullOrEmpty()) {
                return CustomCreatePlaylistDialog()
            }
            return CustomCreatePlaylistDialog().withArgs {
