...
public class InkPageIndicator extends View implements ViewPager.OnPageChangeListener,
    ...
    public InkPageIndicator(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public InkPageIndicator(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        unselectedPaint.setColor(a.getColor(R.styleable.InkPageIndicator_pageIndicatorColor,
                DEFAULT_UNSELECTED_COLOUR));
        selectedPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        selectedPaint.setColor(a.getColor(R.styleable.InkPageIndicator_currentPageIndicatorColor,
